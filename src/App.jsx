    ...
    const call=async(phase,prompt,maxTok,model="claude-sonnet-4-6")=>{
      const res=await fetch(API_ENDPOINT,{
        ...
        body:JSON.stringify({
          ...
          system:[{type:"text",text:phase===1?SYS:SYS_MINI,cache_control:{type:"ephemeral"}}],
...
const AMENITY_CATEGORIES = {
  ...
  "Sports & Fitness": {
    ...
    items: [
      ...
      {id:"pickle_ball", label:"Pickle Ball Court", premium:120},
      {id:"skating_rink", label:"Skating Rink", premium:100},
      {id:"golf_putting", label:"Golf Putting Green", premium:180},
      {id:"fitness_park", label:"Outdoor Fitness Park", premium:80},
      {id:"tennis_multi", label:"Tennis / Multipurpose Court", premium:140},
      {id:"cricket_pitch", label:"Cricket Practice Pitch", premium:100},
      {id:"performance_deck", label:"Performance Deck / Stage", premium:60},
    ]
  },
  "Wellness & Spa": {
    weight: 0.80,
    items: [
      ...
      {id:"yoga_deck", label:"Yoga / Meditation Deck", premium:90},
      {id:"yoga_lawn", label:"Yoga / Meditation Lawn", premium:70},
      {id:"therapeutic_path", label:"Therapeutic Walking Path", premium:80},
      {id:"hammock_zone", label:"Hammock Zone", premium:50},
    ]
  },
  "Community & Social": {
    weight: 0.75,
    items: [
      ...
      {id:"amphitheater_terrace", label:"Amphitheater Terraces", premium:100},
      {id:"community_seating", label:"Community Seating Pods", premium:40},
      {id:"activity_lawn", label:"Activity Lawn", premium:60},
      {id:"party_lawn", label:"Party Lawn", premium:80},
      {id:"viewing_gallery", label:"Viewing Gallery", premium:70},
      {id:"community_orchard", label:"Community Orchard", premium:90},
      {id:"community_street", label:"Community Street / Promenade", premium:60},
    ]
  },
  "Kids & Family": {
    weight: 0.80,
    items: [
      ...
      {id:"toddler_play", label:"Toddler's Play Area", premium:60},
      {id:"swing_pad", label:"Swing Pad", premium:40},
      {id:"wet_pad", label:"Wet Pad with Pool Bed", premium:120},
      {id:"senior_enclosure", label:"Senior Citizen Enclosure", premium:50},
      {id:"pets_park", label:"Pets Park", premium:70},
    ]
  },
  "Green & Landscape": {
    weight: 0.70,
    items: [
      ...
      {id:"butterfly_garden", label:"Butterfly Garden", premium:80},
      {id:"fragrance_garden", label:"Fragrance Garden", premium:70},
      {id:"floral_bed", label:"Floral Bed / Botanical", premium:60},
      {id:"tropical_garden", label:"Tropical Garden", premium:80},
      {id:"lawn_terrace", label:"Lawn Terrace", premium:50},
      {id:"entrance_waterbody", label:"Entrance Waterbody / Fountain", premium:120},
    ]
  },
  "Smart & Tech": {
    weight: 0.75,
    items: [
      ...
      {id:"outdoor_work_pod", label:"Outdoor Working Pod", premium:100},
      {id:"work_station_pods", label:"Work Station Pods", premium:80},
      {id:"outdoor_reading_pod", label:"Outdoor Reading Pod", premium:60},
    ]
  },
  "Retail & Services": {
    weight: 0.55,
  ...
  "Premium / Luxury": {
    ...
    items: [
      ...
      {id:"sunken_court", label:"Sunken Court", premium:150},
      {id:"main_pool_deck", label:"Main Pool + Deck", premium:300},
      {id:"kids_pool_separate", label:"Dedicated Kids' Pool", premium:100},
      {id:"clubhouse_spillout", label:"Clubhouse Spill-Out Court", premium:120},
    ]
  },
};
...
const CITY_TIER_RATES = {
  // Base = cheapest normal flat in the city. Premiums (floor, developer, amenities etc) build it up.
  // Tier 1 normal range: ₹3,500–5,500/sqft → premium can reach ₹9,000–12,000/sqft
  tier1: {apartment:3800, villa:5500, plot:2200, penthouse:7500,
  ...
  tier2: {apartment:2800, villa:3800, plot:1400, penthouse:5000,
...
const LOCALITY_RATES = {
  ...
  "banashankari":        6000,
  "bannerghatta":        5000,
  "electronic city":     4000,
  "electronics city":    4000,
  "hebbal":              7000,
  "hennur":              5500,
  "thanisandra":         5000,
  "yelahanka":           5000,
  ...
  "rt nagar":            6000,
  "rt nagar":            6000,
  "ramamurthy nagar":    5000,
  "kr puram":            4500,
  "kr puram":            4500,
  "domlur":              8500,
  "old airport road":    8000,
  "richmond town":       10500,
  "mg road":             10500,
  "ulsoor":              8500,
  "frazer town":         8000,
  ...
  // ── Chennai ──────────────────────────────────────────────────────────────
  "omr":                 5000,
  "old mahabalipuram road": 5000,
  "ecr":                 5000,
  "east coast road":     5000,
  "velachery":           5500,
  "adyar":               8500,
  "besant nagar":        9000,
  "t nagar":             8500,
  ...
  "vasant kunj":         9000,
  "saket":               10000,
  "greater kailash":     11500,
  "defence colony":      13000,
  "golf course road":    10000,
  "sohna road":          5000,
  "sector 67":           6000,
  "sector 57":           6500,
  "dlf phase":           9000,
  ...
  "sector 83":           5000,
  "sector 108":          5500,
  "noida extension":     3500,
  "greater noida west":  3000,
  "tech zone":           3000,
  "yamuna expressway":   3000,
};
